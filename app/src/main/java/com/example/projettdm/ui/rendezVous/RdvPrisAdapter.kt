...
class RdvPrisAdapter (val context: Context): RecyclerView.Adapter<rdvPrisHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): rdvPrisHolder {
        return rdvPrisHolder(LayoutInflater.from(context).inflate(R.layout.liste_rdv_pris, parent, false))
    }

    @SuppressLint("SetTextI18n")
    override fun onBindViewHolder(holder: rdvPrisHolder, position: Int) {
...
class rdvPrisHolder(view: View) : RecyclerView.ViewHolder(view) {
